...
function Product({ id, title, image, price, rating }) {
    ...
    return (
        <div className=" hover:cursor-pointer flex flex-col items-center h-80 sm:w-1/5 w-1/2 bg-white m-2 rounded-md">
            <img
                src={image}
                alt=""
                className="object-cover mb-3 m-10 overflow-hidden"
